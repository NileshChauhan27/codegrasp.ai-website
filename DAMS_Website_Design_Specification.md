...
The reviewer spends 1–2 minutes. Every element must answer: *"Is this real, technically hard, and worth credits?"*
...
| 15–45 s | Demo Video | 5-minute placeholder showing the PRD-to-code workflow in the Kanban Dashboard. | Founder can present and ship. |
...
- **Roadmap cards:**
  - **DAMS v2.0** — Flagship product. PRD-to-code task automation with defensive memory. *(Shipped)*
...
- Replace the YouTube placeholder with a self-hosted 5-minute PRD-to-code demo.
...
**Demo subtext:** `Create a project, atomize the PRD into Kanban cards, generate queries, warm the SQLite cache, and let the agent write code from a curated scratchpad while native search stays blocked. (5-minute walkthrough — full demo recording incoming.)`
